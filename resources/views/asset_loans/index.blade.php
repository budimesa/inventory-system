<style>
    ...
    <script>
            ...
            $(document).ready(function() {
                ...
                if (filter === 'due_soon') {
                    // Jika parameter 'filter' adalah 'due_soon', aktifkan filter
                    $('#filter-due-soon').trigger('click');
                }
            });
            ...
            $('#table-loan').on('click', '.btn-return', function() {
                ...
                returnData.master_items.forEach(function(item) {
                    var optionText = item.item_name + ' - ' + item.item_type;
                    var newOption = new Option(optionText, item.id, true, true); // Membuat opsi baru
